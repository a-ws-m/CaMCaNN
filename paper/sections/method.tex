...
\begin{description}
    ...
    \item[The Complementary dataset]
          ...
          The Complementary data were used exclusively for external validation. Several
...
information in the representation: the presence of a \ce{(CH2)3} environment
implies the presence of three \ce{CH2} environments, so that there is
...
reason that the molecules in the Complementary data containing elements that
...
$\mathbf{V}^{(1)}$, therefore, encodes not only information about the atom
