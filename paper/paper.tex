...
\affiliation{Physical Chemist, Innospec Ltd., Ellesmere Port, UK}
\author{Ian McRobbie}
...
This is a test: \cite{gaudinNewQSPRModels2016}.
...
\begin{acknowledgement}
    ...
    Unsure whether to acknowledge Andrew's specific contribution (data entry for
    the NIST anionics) or just leave him in the authors, as-is.
