...
\alsoaffiliation[UO]{School of Sustainable Chemical, Biological and Materials Engineering, University of Oklahoma, USA}
\author{Ian McRobbie}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{tocentry}
    \includegraphics[width=\textwidth]{images/toc-graphic.png}
\end{tocentry}
...
grant (EPSRC project number  EP/V032909/1). AS gratefully acknowledges financial
support from the Asahi Glass Chair of Chemical Engineering at the University of
Oklahoma. The authors acknowledge the use of the UCL Myriad High Performance
Computing Facility (Myriad@UCL), and associated support services, in the
completion of this work. All the authors are grateful to Innospec Ltd. for their
support.
\end{acknowledgement}
...
\begin{suppinfo}
    ...
    metrics for hyperparameter optimization and final training, and individual
    model predictions are available at \url{https://github.com/a-ws-m/CaMCaNN/}.
