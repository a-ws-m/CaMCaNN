...
\begin{abstract}
    ...
    that the GNN-based model performs slightly better than the linear ECFP model
    and achieves predictive accuracy that is comparable to published models that
    were evaluated on a smaller range of surfactant chemistries, but the main
    benefit of the GNN model is the ability to provide uncertainty estimates. We
