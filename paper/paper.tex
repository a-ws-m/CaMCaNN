...
\newcommand*{\citeqin}{\citeauthor{qinPredictingCriticalMicelle2021}\cite{qinPredictingCriticalMicelle2021}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Analysing the Accuracy of CMC Predictions using Deep Learning}
...
\begin{abstract}
    ...
    evaluated on a smaller range of surfactant chemistries. We illustrate the
    applicability domain of our model using a molecular cartogram to visualise
...
for their financial support. This work was also supported by the Engineering and
Physical Sciences Research Council (EPSRC), project number EP/VO32909/1. Alberto
Striolo gratefully acknowledges financial support from the Asahi Glass Chair of
Chemical Engineering at the University of Oklahoma. Finally, the authors are
grateful to Innospec Ltd. for their support.
\end{acknowledgement}
